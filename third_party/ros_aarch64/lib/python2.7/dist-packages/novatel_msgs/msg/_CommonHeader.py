...
class CommonHeader(genpy.Message):
  _md5sum = "494e77bac04f74a099ad631ab2cec829"
...
"""
  ...
  __slots__ = ['id','msg_type','port_addr','length','sequence','idle_time','time_status','gps_week','gps_week_milliseconds','receiver_status','reserved','software_version']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,msg_type,port_addr,length,sequence,idle_time,time_status,gps_week,gps_week_milliseconds,receiver_status,reserved,software_version
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_H2B2H2BH2I2H.pack(_x.id, _x.msg_type, _x.port_addr, _x.length, _x.sequence, _x.idle_time, _x.time_status, _x.gps_week, _x.gps_week_milliseconds, _x.receiver_status, _x.reserved, _x.software_version))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.msg_type, _x.port_addr, _x.length, _x.sequence, _x.idle_time, _x.time_status, _x.gps_week, _x.gps_week_milliseconds, _x.receiver_status, _x.reserved, _x.software_version,) = _struct_H2B2H2BH2I2H.unpack(str[start:end])
      return self
