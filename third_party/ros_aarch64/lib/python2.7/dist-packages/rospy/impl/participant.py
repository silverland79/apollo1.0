...
class Participant(_object):
    ...
    def register_common_callback(self, *args): return _participant.Participant_register_common_callback(self, *args)
    def send(self, *args): return _participant.Participant_send(self, *args)
    def income_message(self, *args): return _participant.Participant_income_message(self, *args)
