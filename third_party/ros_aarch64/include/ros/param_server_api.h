...
#ifndef ROSCPP_PARAM_SERVER_API_H
#define ROSCPP_PARAM_SERVER_API_H
 ...
 */
namespace param_server_api
{
ROSCPP_DECL void start_param_server();
ROSCPP_DECL void update_param_server(const std::string &uri);
ROSCPP_DECL void update_param_server(const std::string &host, uint32_t port);
