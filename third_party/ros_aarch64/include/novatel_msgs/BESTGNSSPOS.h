// Generated by gencpp from file novatel_msgs/BESTGNSSPOS.msg
// DO NOT EDIT!


#ifndef NOVATEL_MSGS_MESSAGE_BESTGNSSPOS_H
#define NOVATEL_MSGS_MESSAGE_BESTGNSSPOS_H
...
struct BESTGNSSPOS_
{
  ...
  typedef boost::shared_ptr< ::novatel_msgs::BESTGNSSPOS_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::novatel_msgs::BESTGNSSPOS_<ContainerAllocator> const> ConstPtr;

}; // struct BESTGNSSPOS_

typedef ::novatel_msgs::BESTGNSSPOS_<std::allocator<void> > BESTGNSSPOS;

typedef boost::shared_ptr< ::novatel_msgs::BESTGNSSPOS > BESTGNSSPOSPtr;
typedef boost::shared_ptr< ::novatel_msgs::BESTGNSSPOS const> BESTGNSSPOSConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::novatel_msgs::BESTGNSSPOS_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::novatel_msgs::BESTGNSSPOS_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::novatel_msgs::BESTGNSSPOS_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::novatel_msgs::BESTGNSSPOS_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::novatel_msgs::BESTGNSSPOS_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::novatel_msgs::BESTGNSSPOS_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::novatel_msgs::BESTGNSSPOS_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::novatel_msgs::BESTGNSSPOS_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::novatel_msgs::BESTGNSSPOS_<ContainerAllocator> >
{
  ...
  static const char* value(const ::novatel_msgs::BESTGNSSPOS_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd5581fb4806dc0f3ULL;
  static const uint64_t static_value2 = 0xc7731c438f6b0cc6ULL;
};

template<class ContainerAllocator>
struct DataType< ::novatel_msgs::BESTGNSSPOS_<ContainerAllocator> >
{
  static const char* value()
  {
    return "novatel_msgs/BESTGNSSPOS";
  }
...
template<class ContainerAllocator>
struct Definition< ::novatel_msgs::BESTGNSSPOS_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# message 42\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::novatel_msgs::BESTGNSSPOS_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::novatel_msgs::BESTGNSSPOS_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::novatel_msgs::BESTGNSSPOS_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // NOVATEL_MSGS_MESSAGE_BESTGNSSPOS_H
