...
if("FALSE" STREQUAL "TRUE")
  set(tf2_SOURCE_PREFIX /home/ubuntu/baidu/adu-lab/apollo/modules/ros/geometry2/tf2)
  set(tf2_DEVEL_PREFIX /home/ubuntu/baidu/adu-lab/apollo/modules/devel_isolated/tf2)
  set(tf2_INSTALL_PREFIX "")
  set(tf2_PREFIX ${tf2_DEVEL_PREFIX})
else()
  set(tf2_SOURCE_PREFIX "")
  set(tf2_DEVEL_PREFIX "")
  set(tf2_INSTALL_PREFIX /home/ubuntu/baidu/adu-lab/apollo/third_party/ros)
...
if(NOT "include;/usr/local/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/baidu/adu-lab/apollo/third_party/ros/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(tf2_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "tf2;/usr/local/lib/libconsole_bridge.so")
