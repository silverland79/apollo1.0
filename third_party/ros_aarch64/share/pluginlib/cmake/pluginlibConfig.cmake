...
if("FALSE" STREQUAL "TRUE")
  set(pluginlib_SOURCE_PREFIX /home/ubuntu/baidu/adu-lab/apollo/modules/ros/pluginlib)
  set(pluginlib_DEVEL_PREFIX /home/ubuntu/baidu/adu-lab/apollo/modules/devel_isolated/pluginlib)
  ...
  set(pluginlib_INSTALL_PREFIX /home/ubuntu/baidu/adu-lab/apollo/third_party/ros)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pluginlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/baidu/adu-lab/apollo/third_party/ros/${idir}'.  Ask the maintainer 'Mikael Arguedas <mikael@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(pluginlib_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/aarch64-linux-gnu/libboost_filesystem.so;/usr/lib/aarch64-linux-gnu/libboost_system.so;/home/ubuntu/baidu/adu-lab/apollo/third_party/ros/lib/libtinyxml.so")
