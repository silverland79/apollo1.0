...
if("FALSE" STREQUAL "TRUE")
  set(rospack_SOURCE_PREFIX /home/ubuntu/baidu/adu-lab/apollo/modules/ros/rospack)
  set(rospack_DEVEL_PREFIX /home/ubuntu/baidu/adu-lab/apollo/modules/devel_isolated/rospack)
  set(rospack_INSTALL_PREFIX "")
  set(rospack_PREFIX ${rospack_DEVEL_PREFIX})
else()
  set(rospack_SOURCE_PREFIX "")
  set(rospack_DEVEL_PREFIX "")
  set(rospack_INSTALL_PREFIX /home/ubuntu/baidu/adu-lab/apollo/third_party/ros)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rospack' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/baidu/adu-lab/apollo/third_party/ros/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(rospack_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rospack;/usr/lib/aarch64-linux-gnu/libpython2.7.so;/usr/lib/aarch64-linux-gnu/libboost_filesystem.so;/usr/lib/aarch64-linux-gnu/libboost_program_options.so;/usr/lib/aarch64-linux-gnu/libboost_system.so;/home/ubuntu/baidu/adu-lab/apollo/third_party/ros/lib/libtinyxml.so")
