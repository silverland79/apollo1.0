...
macro(_generate_proto_cpp ARG_PKG ARG_MSG ARG_IFLAGS ARG_GEN_OUTPUT_DIR CC_FILE)
  ...
  assert(CATKIN_ENV)
  message("${GENPROTO_PY_BIN} ${ARG_IFLAGS} --cpp_out=${ARG_GEN_OUTPUT_DIR} ${ARG_MSG}")
  ...
  gencpp_append_include_dirs()
#  if(NOT gencpp_APPENDED_PROTO_INCLUDE_DIRS)
#    include_directories(BEFORE ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/${ARG_PKG})
#    list(APPEND ${PROJECT_NAME}_INCLUDE_DIRS ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/${ARG_PKG})
#    set(gencpp_APPENDED_PROTO_INCLUDE_DIRS TRUE)
#  endif()
  install(
