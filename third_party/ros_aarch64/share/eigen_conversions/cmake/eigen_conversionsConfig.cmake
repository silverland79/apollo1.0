...
if("FALSE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /home/ubuntu/baidu/adu-lab/apollo/modules/ros/geometry/eigen_conversions)
  set(eigen_conversions_DEVEL_PREFIX /home/ubuntu/baidu/adu-lab/apollo/modules/devel_isolated/eigen_conversions)
  ...
  set(eigen_conversions_INSTALL_PREFIX /home/ubuntu/baidu/adu-lab/apollo/third_party/ros)
...
if(NOT "include;/usr/include/eigen3;/home/ubuntu/baidu/adu-lab/apollo/third_party/ros/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/baidu/adu-lab/apollo/third_party/ros/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(eigen_conversions_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "eigen_conversions;/home/ubuntu/baidu/adu-lab/apollo/third_party/ros/lib/liborocos-kdl.so.1.3.0")
