...
if("FALSE" STREQUAL "TRUE")
  set(pluginlib_SOURCE_PREFIX /tmp/apollo-platform/ros/pluginlib)
  set(pluginlib_DEVEL_PREFIX /tmp/apollo-platform/ros/devel_isolated/pluginlib)
  ...
  set(pluginlib_INSTALL_PREFIX /apollo/third_party/ros_x86_64)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pluginlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/apollo/third_party/ros_x86_64/${idir}'.  Ask the maintainer 'Mikael Arguedas <mikael@osrfoundation.org>' to fix it.")
    endif()
