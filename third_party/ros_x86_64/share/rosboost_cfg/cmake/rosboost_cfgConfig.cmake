...
if("FALSE" STREQUAL "TRUE")
  set(rosboost_cfg_SOURCE_PREFIX /tmp/apollo-platform/ros/ros/rosboost_cfg)
  set(rosboost_cfg_DEVEL_PREFIX /tmp/apollo-platform/ros/devel_isolated/rosboost_cfg)
  ...
  set(rosboost_cfg_INSTALL_PREFIX /apollo/third_party/ros_x86_64)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosboost_cfg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/apollo/third_party/ros_x86_64/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
