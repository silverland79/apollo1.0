...
if("FALSE" STREQUAL "TRUE")
  set(rospy_tutorials_SOURCE_PREFIX /tmp/apollo-platform/ros/ros_tutorials/rospy_tutorials)
  set(rospy_tutorials_DEVEL_PREFIX /tmp/apollo-platform/ros/devel_isolated/rospy_tutorials)
  ...
  set(rospy_tutorials_INSTALL_PREFIX /apollo/third_party/ros_x86_64)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rospy_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/apollo/third_party/ros_x86_64/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
