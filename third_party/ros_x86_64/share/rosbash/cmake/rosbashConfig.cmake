...
if("FALSE" STREQUAL "TRUE")
  set(rosbash_SOURCE_PREFIX /tmp/apollo-platform/ros/ros/rosbash)
  set(rosbash_DEVEL_PREFIX /tmp/apollo-platform/ros/devel_isolated/rosbash)
  set(rosbash_INSTALL_PREFIX "")
  set(rosbash_PREFIX ${rosbash_DEVEL_PREFIX})
else()
  set(rosbash_SOURCE_PREFIX "")
  set(rosbash_DEVEL_PREFIX "")
  set(rosbash_INSTALL_PREFIX /apollo/third_party/ros_x86_64)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbash' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/apollo/third_party/ros_x86_64/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
