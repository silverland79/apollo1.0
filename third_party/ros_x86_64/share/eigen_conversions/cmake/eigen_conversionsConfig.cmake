...
if("FALSE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /tmp/apollo-platform/ros/geometry/eigen_conversions)
  set(eigen_conversions_DEVEL_PREFIX /tmp/apollo-platform/ros/devel_isolated/eigen_conversions)
  ...
  set(eigen_conversions_INSTALL_PREFIX /apollo/third_party/ros_x86_64)
...
if(NOT "include;/usr/include/eigen3;/apollo/third_party/ros_x86_64/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/apollo/third_party/ros_x86_64/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(eigen_conversions_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "eigen_conversions;/apollo/third_party/ros_x86_64/lib/liborocos-kdl.so.1.3.0")
