...
if("FALSE" STREQUAL "TRUE")
  set(stereo_msgs_SOURCE_PREFIX /tmp/apollo-platform/ros/common_msgs/stereo_msgs)
  set(stereo_msgs_DEVEL_PREFIX /tmp/apollo-platform/ros/devel_isolated/stereo_msgs)
  ...
  set(stereo_msgs_INSTALL_PREFIX /apollo/third_party/ros_x86_64)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'stereo_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/apollo/third_party/ros_x86_64/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
