...
if("FALSE" STREQUAL "TRUE")
  set(gencpp_SOURCE_PREFIX /tmp/apollo-platform/ros/gencpp)
  set(gencpp_DEVEL_PREFIX /tmp/apollo-platform/ros/devel_isolated/gencpp)
  set(gencpp_INSTALL_PREFIX "")
  set(gencpp_PREFIX ${gencpp_DEVEL_PREFIX})
else()
  set(gencpp_SOURCE_PREFIX "")
  set(gencpp_DEVEL_PREFIX "")
  set(gencpp_INSTALL_PREFIX /apollo/third_party/ros_x86_64)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gencpp' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/apollo/third_party/ros_x86_64/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
