...
if("FALSE" STREQUAL "TRUE")
  set(roslang_SOURCE_PREFIX /tmp/apollo-platform/ros/ros/roslang)
  set(roslang_DEVEL_PREFIX /tmp/apollo-platform/ros/devel_isolated/roslang)
  set(roslang_INSTALL_PREFIX "")
  set(roslang_PREFIX ${roslang_DEVEL_PREFIX})
else()
  set(roslang_SOURCE_PREFIX "")
  set(roslang_DEVEL_PREFIX "")
  set(roslang_INSTALL_PREFIX /apollo/third_party/ros_x86_64)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roslang' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/apollo/third_party/ros_x86_64/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
