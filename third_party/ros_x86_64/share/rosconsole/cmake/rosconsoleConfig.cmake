...
if("FALSE" STREQUAL "TRUE")
  set(rosconsole_SOURCE_PREFIX /tmp/apollo-platform/ros/ros_comm/rosconsole)
  set(rosconsole_DEVEL_PREFIX /tmp/apollo-platform/ros/devel_isolated/rosconsole)
  ...
  set(rosconsole_INSTALL_PREFIX /apollo/third_party/ros_x86_64)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosconsole' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/apollo/third_party/ros_x86_64/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
